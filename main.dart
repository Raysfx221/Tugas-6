      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            const CircleAvatar(
              radius: 80,
              backgroundImage: AssetImage('assets/babang.jpg'),
            ),
                ...
                child: Column(
                  children: <Widget>[
                    ListTile(
                      ...
                      subtitle: const Text('23 Mei 2003'),
                    ),
                    Divider(color: Colors.grey.shade300, thickness: 1),
                    ListTile(
                      leading: const Icon(Icons.web, color: Colors.blue),
                      title: const Text('Website'),
                      subtitle: const Text('rasyidainul221.com'),
                      onTap: () {},
                    ),
                    Divider(color: Colors.grey.shade300, thickness: 1),
                    ListTile(
                      ...
                      subtitle: const Text('rasyidainul221@gmail.com'),
                    ),
                    Divider(color: Colors.grey.shade300, thickness: 1),
                    ListTile(
